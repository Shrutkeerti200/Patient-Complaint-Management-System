...
public class ViewComplaintsJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewComplaintsJPanel(JPanel userProcessContainer, ComplaintDirectory complaintDirectory, String complaintId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtPriorityLevel = new javax.swing.JTextField();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtPriorityLevel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblDescription)
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        if (userProcessContainer.getComponent(userProcessContainer.getComponentCount() - 1) instanceof HealthCareProfessionalWorkAreaJPanel) {
            HealthCareProfessionalWorkAreaJPanel previousPanel = (HealthCareProfessionalWorkAreaJPanel) userProcessContainer.getComponent(userProcessContainer.getComponentCount() - 1);
...
//        txtComplaintID.setText(selectedComplaint.getComplaintId());
//        txtPatientID.setText(selectedComplaint.getPatient().getPatientId()); // Fetch Patient ID
//        txtPatientName.setText(selectedComplaint.getPatient().getName()); // Fetch Patient Name
//        txtPatientAge.setText(selectedComplaint.getPatient().getAge()); // Fetch Patient Age
//        txtComplaintType.setText(selectedComplaint.getComplaintType());
//        txtPriorityLevel.setText(selectedComplaint.getPriorityLevel());
//        txtDescription.setText(selectedComplaint.getDescription());
//        cbStatus.setSelectedItem(selectedComplaint.getStatus());
//        txtDate.setText(selectedComplaint.getTimestamp().toString());
        ...
        txtPriorityLevel.setText(selectedComplaint.getPriorityLevel() != null ? selectedComplaint.getPriorityLevel() : "");
    ...
    private javax.swing.JTextField txtPriorityLevel;
